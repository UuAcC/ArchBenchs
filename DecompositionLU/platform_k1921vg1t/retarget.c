/*==============================================================================
 * Перенаправление printf() для К1921ВГ1Т
 *------------------------------------------------------------------------------
...
void retarget_init()
{
    ...
    RCU->CGCFGAPB2_bit.UART0EN = 1;
    RCU->RSTDISAPB2_bit.UART0EN = 1;

    RETARGET_UART_PORT->ALTFUNCNUM0_bit.PIN0 = 3;
    RETARGET_UART_PORT->ALTFUNCNUM0_bit.PIN1 = 3;
