...
void mtimer_set_raw_time_cmp(uint64_t clock_offset) {
    ...
    volatile uint32_t *mtimecmpl = (volatile uint32_t *)(MEM_MTIMECMP);
    volatile uint32_t *mtimecmph = (volatile uint32_t *)(MEM_MTIMECMP+4);
...
uint64_t mtimer_get_raw_time(void) {
    ...
    volatile uint32_t * mtimel = (volatile uint32_t *)(MEM_MTIME);
    volatile uint32_t * mtimeh = (volatile uint32_t *)(MEM_MTIME+4);
    uint32_t mtimeh_val;
    uint32_t mtimel_val;
    do {
