...
enum {
    RISCV_IRQ_MSI = 3,	/* Machine Software Interrupt */
    RISCV_IRQ_MTI = 7,	/* Machine Timer Interrupt */
    RISCV_IRQ_MEI = 11,	/* Machine External Interrupt */
    RISCV_IRQ_SSI = 1,	/* Supervisor Software Interrupt */
    RISCV_IRQ_STI = 5,	/* Supervisor Timer Interrupt */
    RISCV_IRQ_SEI = 9,	/* Supervisor External Interrupt */
    RISCV_IRQ_USI = 0,	/* User Software Interrupt */
    RISCV_IRQ_UTI = 4,	/* User Timer Interrupt */
    RISCV_IRQ_UEI = 8,	/* User External Interrupt */
};
